...
<div class="top">
	...
	<div class="right">
		...
		<div class="info">
			...
			<h2>강남 648호텔</h2>
			<div class="score_cnt">
				<span>8.4</span>만족해요<b id="review_cnt">&nbsp;리뷰 <em>384</em>개</b>
				<p><a href="tel:050440442432" class="call">전화하기</a></p>
			</div>
...
<form id="product_filter_form" method="get" action="https://www.goodchoice.kr/product/detail" data-sel_date="2022-06-03" data-sel_date2="2022-06-04">
	...
	<!-- 날짜 선택 -->
	<div class="btn_date">
		<span class="date_view"><b>6.3 ~ 6.4</b><em>&nbsp;·&nbsp;1박</em></span><strong>변경</strong>
	</div>
	...
	<div class="room">
		<!-- 282 x 169 -->
		<p class="pic_view ">
			<img class="lazy" data-original="//image.goodchoice.kr/resize_370x220/adimg_new/2954/363781/6a7b0cd8e3f4cea76b61b046a2900cc5.jpg" src="//image.goodchoice.kr/resize_1000X500x0/adimg_new/list_none.png" alt="강남 648호텔 | 디럭스룸 24시패키지(2인기준)">
		</p>
		<div class="cal_bg"><button type="button">닫기</button></div>
		...
		<div class="pic_wrap">
			...
			<div class="gallery_m index_mobile swiper_detail">
				<div class="swiper-container swiper-default swiper-container-horizontal">
					...
					<div class="spinner_slide"><span></span></div>
					<div class="index"><p><span>1</span> / <span>4</span></p></div>
				</div>
			</div>
			<div class="gallery_m index_mobile">
		...
		<div class="info">
			<div class="half none">
				<div class="price">
					<strong>대실</strong>
					<div>
						<p class="through_none" style="text-decoration: inherit; visibility: hidden;"></p><p>숙소에 문의</p>
					</div>
					<ul>
						<li><span>마감시간</span>20시까지&nbsp;</li>
						<li><span>이용시간</span>최대 4시간&nbsp;</li>
					</ul>
				</div>
			...
			<div class="half none">
				<div class="price">
					...
					<ul>
						<li><span>입실시간</span>18시부터&nbsp;</li>
						<li><span>퇴실시간</span>익일12시&nbsp;</li>
					</ul>
				</div>
				<button type="button" onclick="location.href='javascript:void(0)';" class="" style="">숙소에 문의 하세요</button>
			</div>
	...
	<div class="room">
		<!-- 282 x 169 -->
		<p class="pic_view ">
			<img class="lazy" data-original="//image.goodchoice.kr/resize_370x220/adimg_new/2954/331040/287598cd268ce38e489a52387685ae36.jpg" src="//image.goodchoice.kr/resize_1000X500x0/adimg_new/list_none.png" alt="강남 648호텔 | 파크 디럭스(2인 기준)">
		</p>
		<div class="cal_bg"><button type="button">닫기</button></div>
					...
					<ul class="nav owl-carousel owl-loaded owl-drag">
                        <div class="owl-stage-outer">
                        	<div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s;">
                        		<div class="owl-item">
                        			<li class="item on">
                        				<img class="owl-lazy" data-src="//image.goodchoice.kr/resize_490x348/adimg_new/2954/331040/287598cd268ce38e489a52387685ae36.jpg" alt="강남 648호텔 | 파크 디럭스(2인 기준)" src="//image.goodchoice.kr/resize_490x348/adimg_new/2954/331040/287598cd268ce38e489a52387685ae36.jpg" style="opacity: 1;">
                       				</li>
								</div>
                  				<div class="owl-item">
	                  				<li class="item on">
	                  					<img class="owl-lazy" data-src="//image.goodchoice.kr/resize_490x348/adimg_new/2954/331040/d124c702fa83b1df2023a51456b0774e.jpg" alt="강남 648호텔 | 파크 디럭스(2인 기준)">
	                  				</li>
                  				</div>
                  				<div class="owl-item">
	                  				<li class="item on">
	                  					<img class="owl-lazy" data-src="//image.goodchoice.kr/resize_490x348/adimg_new/2954/331040/ebe9362a3cbd2975a822bd0e481b7fbe.jpg" alt="강남 648호텔 | 파크 디럭스(2인 기준)">
	                  				</li>
                  				</div>
							</div>
						</div>
				...
				<div class="half">
					<div class="price">
						...
						<div>
							...
							<!-- 표시금액 -->
							<p><span>예약</span><b style="color: rgba(0,0,0,1)">40,000원</b></p>
						</div>
						<ul>
							<li><span>마감시간</span>19시까지&nbsp;</li>
							<li><span>이용시간</span>최대 4시간&nbsp;</li>
						</ul>
					</div>
				...
				<div class="half ended">
					<div class="price">
						...
						<div>
							<p class="through_none" style="text-decoration: inherit; visibility: hidden;">0</p>
							<!-- 표시금액 -->
							<p><b style="color: rgba(0,0,0,1)">90,000원</b></p>
						</div>
						<ul>
							<li><span>입실시간</span>18시부터&nbsp;</li>
							<li><span>퇴실시간</span>익일12시&nbsp;</li>
