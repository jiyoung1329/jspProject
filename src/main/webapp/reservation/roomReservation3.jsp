...
Date endTime = format.parse(Integer.toString(end) + ":00");
								...
								<div class="right" data-v-33033856="" data-v-f785cca6="">
									...
									<div class="reserve_info mypageForm__form-inputs-wrap"
										...
										<input type="text" name="price" aria-hidden="true"
											style="display: none;" value="<%=price%>"> <input
											type="text" name="accomNum" aria-hidden="true"
											style="display: none;" value="<%=accomNum%>"> <input
											type="text" name="roomNum" aria-hidden="true"
											style="display: none;" value="<%=rNum%>"> <input
											type="text" name="selDate" aria-hidden="true"
											style="display: none;" value="<%=selDate%>"> <input
											type="text" name="selDate2" aria-hidden="true"
											style="display: none;" value="<%=selDate2%>">
										...
										<input class="visit_input" type="text" name="visit"
											...
											<div class="owl-stage-outer">
												<div class="owl-stage"
													...
													<div class="owl-item active"
														...
														<button data-v-b5c15754="" data-time="10:00"
															class="item enable">10:00</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="10:30"
															class="item enable">10:30</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="11:00"
															class="item enable">11:00</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="11:30"
															class="item enable">11:30</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="12:00"
															class="item enable">12:00</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="12:30"
															class="item enable">12:30</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="13:00"
															class="item enable">13:00</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="13:30"
															class="item enable">13:30</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T14:00:00"
															class="item enable">14:00</button>
													</div>
													<div class="owl-item active"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T14:30:00"
															class="item enable">14:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T15:00:00"
															class="item">15:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T15:30:00"
															class="item">15:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T16:00:00"
															class="item">16:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T16:30:00"
															class="item">16:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T17:00:00"
															class="item">17:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T17:30:00"
															class="item">17:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T18:00:00"
															class="item">18:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T18:30:00"
															class="item">18:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T19:00:00"
															class="item">19:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T19:30:00"
															class="item">19:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T20:00:00"
															class="item">20:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T20:30:00"
															class="item">20:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T21:00:00"
															class="item">21:00</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T21:30:00"
															class="item">21:30</button>
													</div>
													<div class="owl-item"
														style="width: 64.75px; margin-right: 2px;">
														<button data-v-b5c15754="" data-time="2022-06-23T22:00:00"
